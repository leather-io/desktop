  ...
  return (
    <Onboarding maxWidth="800px" px="base-loose">
      ...
      <Box textStyle="body.small" mx="base">
        These terms of use (“<strong>Terms</strong>”) govern your use of the Leather Wallet, LLC
        software (the “<strong>Software</strong>”) made available to you by {FULL_ENTITY_NAME} (“
